...
Weapon::Weapon(int id) {
    ...
    while (getline(fin, temp, '\n')){ // Search for line with right ID in file, then put it in string stream
    ...
    stringstream s(temp);
    s >> ID >> name >> damage; // Set variables
...
void Weapon::reconstruct(int id) { // Same as constructor
    ifstream fin;
    fin.open("Weapons.txt");
    string temp;
    int idCompare;
...
void Weapon::print() { // Used for testing only
